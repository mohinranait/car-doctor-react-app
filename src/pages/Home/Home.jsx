...
import MeetTeams from '../../components/MeetTeams/MeetTeams';
                ...
                <div className="lg:container lg:flex">
                    <div className='lg:w-1/2 relative'>
                        <div className=' lg:w-[90%]'>
                            <div>
                                <img src={person} className='rounded-md' alt="" />
                            </div>
                            <img className='absolute -bottom-10 lg:-right-7 w-[50%] p-2 bg-white rounded-md border-white' src={parts} alt="" />
                        </div>
                    </div>
                    <div className='lg:w-1/2'>
                        <div className='pl-10 pr-10 space-y-3'>
                            <p className='font-bold text-primary text-lg'>About Us</p>
                            <h2 className='text-3xl font-bold text-title'>We are qualified & of experience in this field</h2>
                            <p className='text-muted text-base '>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable. </p>
                            <p className='text-muted text-base '>the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable. </p>
                            <div>
                                <button className='btn bg-primary border-primary'>Get More Info</button>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="box bg-title py-16 px-12  rounded-md">
                    <ul className=' space-y-6 md:space-x-0 md:flex items-center justify-between'>
                        <li className='flex items-center gap-3'>
                            ...
                            <div>
                                <p className='text-base font-meidum text-white'>We are open monday-friday</p>
                        ...
                        <li className='flex items-center gap-3'>
                            ...
                            <div>
                                <p className='text-base font-meidum text-white'>Have a question?</p>
